...
namespace BuildApp.Models.DAL
{
    public class DBservices
    {
        ...
        public List<string> GetUsersByAddressId(int addressId)
        {
            SqlConnection con = null;
            try
            {
                con = connect("DBConnectionString");
                String selectSTR = $"SELECT UserName FROM BuildApp_UserInAddress where AddressId={addressId}";
        ...
        public string AddUserSettings(Settings s)
        {
            ...
            string cStr = $"INSERT INTO BuildApp_UserSettings ([UserName],[Babysitter],[Dogwalker],[Carpool],[Groceries],[Avalability]) VALUES('{s.UserName}', '{s.BabySitter}', '{s.Dogwalker}', '{s.Carpool}', '{s.Groceries}', '{s.Avalability}')";
        ...
        public string UpdateUserSettings(Settings s)
        {
            ...
            string cStr = $"UPDATE BuildApp_UserSettings SET Babysitter='{s.BabySitter}',Dogwalker='{s.Dogwalker}',Carpool='{s.Carpool}',Groceries='{s.Groceries}',Avalability='{s.Avalability}'  WHERE UserName='{s.UserName}'";
        ...
        {
            List<string> usersInAddress = GetUsersByAddressId(r.AddressId);
